...
$check_user=mysqli_fetch_array($run_user);
	if($check_user!=true)
	{
		$ins=mysqli_query($con,"INSERT INTO users (stuid,password,s_name) VALUES ('$stuid','$stupasswd','$username')");
		if($ins==true)
		{
		echo "<h3 style='font-family:georgia;color:green;'>You have registered successfully....</h3>";
